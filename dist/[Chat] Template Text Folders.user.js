// ==UserScript==
// @name               [Chat] Template Text Folders [20260609] v1.0.6
// @name:zh-CN         [聊天] 模板文本文件夹 [20260609] v1.0.6
// @name:en            [Chat] Template Text Folders [20260609] v1.0.6
...
//
// @version            [20260609] v1.0.6
// @update-log         对齐 header 字段与 @match 分组显示列，调整 Mistral 分组位置，并同步中英文 metadata。
// @update-log:zh-CN   对齐 header 字段与 @match 分组显示列，调整 Mistral 分组位置，并同步中英文 metadata。
// @update-log:en      Align header fields and @match group columns, move the Mistral group, and sync bilingual metadata.
//
...
`;
  ...
  console.log("🎉 [Chat] Template Text Folders [20260601] v1.0.1 🎉");
