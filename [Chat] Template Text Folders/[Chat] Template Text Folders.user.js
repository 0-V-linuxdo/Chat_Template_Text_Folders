...
/* ========================================================================== *
 * ⚠️ 这是一个自动生成的文件：请在 src/modules 目录下的模块中进行修改，然后运行 `npm run build` 重新生成。
 * ⚠️ This file is auto-generated: edit the modules under src/modules, then run `npm run build` to regenerate.
 * ========================================================================== */
