...
(function (global) {
    ...
    const EN_TRANSLATIONS = {
        ...
        "语言": "Language",
        "同步": "Sync",
        "☁️ Google Drive 同步": "☁️ Google Drive Sync",
        "内置模块": "Built-in module",
        "Drive 同步模块已内置，默认关闭。开启后显示配置并初始化同步功能。": "Drive sync is built in and off by default. Enable to show settings and initialize sync.",
        "开启后启用 Drive 同步配置": "Enable to show Drive sync settings",
        "客户端 ID": "Client ID",
        "客户端密钥": "Client Secret",
        ...
        "读取方式": "Request mode",
        "默认": "Default",
        "适配：AdGuard": "AdGuard-friendly",
        "默认优先 GM 请求；AdGuard 模式优先 fetch。": "Default tries GM first; AdGuard mode prefers fetch first.",
        "当前模式：适配 AdGuard（优先 fetch）": "Current mode: AdGuard-friendly (fetch first)",
        "当前模式：默认（优先 GM 请求）": "Current mode: Default (GM first)",
        "优先 GM 请求": "Prefer GM request",
        "优先 fetch": "Prefer fetch",
        "保存 Drive 设置": "Save Drive Settings",
        "上传配置到 Drive": "Upload Config to Drive",
        "从 Drive 拉取配置": "Pull Config from Drive",
        "上传配置": "Upload Config",
        "拉取配置": "Pull Config",
        "正在检查云端配置…": "Checking Drive config…",
        "Drive 设置已保存。": "Drive settings saved.",
        "请先填写完整的 Drive 凭据。": "Please fill in all Drive credentials.",
        "当前环境不支持跨域请求，请在脚本管理器中启用 GM_xmlhttpRequest。": "Cross-origin requests are unavailable; please enable GM_xmlhttpRequest in your userscript manager.",
        "正在初始化 Drive 同步模块…": "Initializing Drive sync module…",
        "正在上传到 Drive…": "Uploading to Drive…",
        "正在从 Drive 下载配置…": "Downloading config from Drive…",
        "配置已与 Drive 同步。": "Config synced with Drive.",
        "Drive 同步默认关闭，开启后再启用。": "Drive sync is off by default; enable it to turn on.",
        "未找到云端配置文件。": "No Drive config file found.",
        "云端配置格式无效！": "Drive config has an invalid format!",
        "云端配置与本地完全相同，无需更新。": "Drive config matches local; no update needed.",
        "操作已取消，配置保持不变。": "Operation cancelled, configuration unchanged.",
        "已应用云端配置。": "Applied Drive config.",
        "已使用云端配置覆盖本地，未上传本地修改。": "Applied Drive config locally (kept cloud version, skipped local upload).",
        "已使用云端配置覆盖本地，并完成同步。": "Applied Drive config locally and completed sync.",
        "已将本地配置上传到 Drive。": "Uploaded local config to Drive.",
        "检测到云端与本地配置存在差异": "Drive and local configs differ",
        "当前操作：上传到 Drive": "Current action: Upload to Drive",
        "当前操作：从 Drive 拉取": "Current action: Pull from Drive",
        "请选择以本地或云端配置为准，点击“查看差异”可展开详细对比。": "Choose whether to keep local or Drive config. Click \"View Diff\" for details.",
        "云端配置": "Drive config",
        "以本地为准（上传到云端）": "Use local (upload to Drive)",
        "以云端为准（覆盖本地）": "Use Drive version (overwrite local)",
        "Drive 请求失败：": "Drive request failed:"
};
